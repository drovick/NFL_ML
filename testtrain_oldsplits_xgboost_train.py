...
i_list,e_list,t_list,iters,subs,rates,estimators,maxdeps,minsamps,maxfeats,minimp_decs = gbr_multitree_loop_lin_results(['XGBRegressor'],train_set_input_normalized,train_set_output,train_set_input_normalized,train_set_output,input_cols,output_cols,n_iter_no_change__=+50,subsample=[float(1.0),float(+0.1),float(+0.01),float(+0.001)],learning_rate=[float(0.1),float(0.05),float(0.01),float(0.0005),float(0.00001)],n_estimators=[500],max_depths=[110],min_samples_leafs=[2],max_featuress=[0.8,0.6,0.4],min_impurity_decreases=[float(0.001)])
