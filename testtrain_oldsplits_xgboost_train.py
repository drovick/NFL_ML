...
import pickle
filename = 'smallbatch_testtrain_oldsplits_xgb_pickle_1'
...
i,e,t,it,su,ra,estimat,maxd,minsa,maxfe,minidecs = gbr_multitree_loop_lin_results(['XGBRegressor'],train_set_input_normalized,train_set_output,val_set_input_normalized,val_set_output,input_cols,output_cols,n_iter_no_change__=+200,subsample=[float(+0.01),float(+0.005),float(+0.0001)],learning_rate=[float(0.001),float(0.005),float(0.001),float(0.00005),float(0.00001)],n_estimators=[500],max_depths=[40,45,60],min_samples_leafs=[2],max_featuress=[0.25,0.15],min_impurity_decreases=[float(0.0005)])
