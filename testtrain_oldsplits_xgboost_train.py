...
i_list,e_list,t_list,iters,subs,rates,estimators,maxdeps,minsamps,maxfeats,minimp_decs = gbr_multitree_loop_lin_results(['XGBRegressor'],train_set_input_normalized,train_set_output,train_set_input_normalized,train_set_output,input_cols,output_cols,n_iter_no_change__=+50,subsample=[float(1.0),float(+0.1),float(+0.01)],learning_rate=[float(0.1),float(0.05),float(0.01),float(0.0005)],n_estimators=[60],max_depths=[110],min_samples_leafs=[2],max_featuress=[0.8,0.6,0.4],min_impurity_decreases=[float(0.001)])
...
import pickle
filename = 'normal_oldsplits_xgb_pickle_1'
...
i,e,t,it,su,ra,estimat,maxd,minsa,maxfe,minidecs = gbr_multitree_loop_lin_results(['XGBRegressor'],train_set_input_normalized,train_set_output,train_set_input_normalized,train_set_output,input_cols,output_cols,n_iter_no_change__=+100,subsample=[float(+0.01),float(+0.005),float(+0.0001)],learning_rate=[float(0.001),float(0.005),float(0.001),float(0.00005),float(0.00001)],n_estimators=[60],max_depths=[80,70],min_samples_leafs=[2],max_featuress=[0.5,0.4,0.3],min_impurity_decreases=[float(0.001),float(0.0005)])
...
filename = 'smallbatch_testtrain_oldsplits_xgb_pickle_2'
outfile = open(filename,'wb')
pickle_objs = [i_list,e_list,t_list,iters,subs,rates,estimators,maxdeps,minsamps,maxfeats,minimp_decs]
...
i,e,t,it,su,ra,estimat,maxd,minsa,maxfe,minidecs = gbr_multitree_loop_lin_results(['XGBRegressor'],train_set_input_normalized,train_set_output,train_set_input_normalized,train_set_output,input_cols,output_cols,n_iter_no_change__=+100,subsample=[float(+0.01),float(+0.005),float(+0.0001)],learning_rate=[float(0.001),float(0.005),float(0.001),float(0.00005),float(0.00001)],n_estimators=[60],max_depths=[40,45,60],min_samples_leafs=[2],max_featuress=[0.25,0.15],min_impurity_decreases=[float(0.001),float(0.0005)])
...
filename = 'smallbatch_testtrain_oldsplits_xgb_pickle'
outfile = open(filename,'wb')
