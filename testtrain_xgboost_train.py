...
import pickle
filename = 'normal_testtrain_xgbpickle_1'
...
filename = 'smallbatch_testtrain_xgbpickle_2'
outfile = open(filename,'wb')
pickle_objs = [i_list,e_list,t_list,iters,subs,rates,estimators,maxdeps,minsamps,maxfeats,minimp_decs]
...
filename = 'smallbatch_testtrain_xgb_pickle'
outfile = open(filename,'wb')
