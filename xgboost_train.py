...
def gbr_multitree_fit_errors(model,train_in,train_out,test_in,test_out,input_cols_,output_cols_,n_iter_no_change_=None,subsample_=0.1,learning_rate_=0.1,n_estimators_=10,max_depth_=20,min_samples_leaf_=1,max_features_=1.0,min_impurity_decrease_=0):
    ...
    tree_model = xgb.XGBRegressor(params,max_depth=max_depth_,early_stopping_rounds=n_iter_no_change_,subsample=subsample_,learning_rate=learning_rate_,n_estimators=n_estimators_,min_child_weight=min_samples_leaf_,colsample_bytree=max_features_,gamma=min_impurity_decrease_)
